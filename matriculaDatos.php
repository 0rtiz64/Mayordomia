...
session_start();
      ...
      <form class="form-horizontal" id="formularioReporteEquipo">
          <section class="main-content-wrapper">
              <section id="main-content">
                  <div class="row">
                      <h1 class="h1">Contador Matricula</h1>
                      <div class="col-md-12">
                          <div class="col-md-12 form-group">
                              <input type="date" class="form-control" placeholder="FECHA" id="fechaDatos">
                          </div>

                          <div class="col-md-12 form-group" id="resultados">
                          </div>
                      </div>
  ...
  <script src="js/matriculaDatos.js"></script>
