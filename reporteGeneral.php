    ...
    <form class="form-horizontal" id="formularioReporteEquipo">
        <section class="main-content-wrapper">
            <section id="main-content">
                <div class="row">
                    <h1 class="h1">REPORTE GENERAL DE ASISTENCIA</h1>
                    <div class="col-md-12">

                        <div class="col-md-10 form-group" id="divFechaReporteGeneral">
                            <label>SELECCIONE FECHA:</label>
                            <input type="date" class="form-control" id="fechaReporteProvicional">
                        </div>
                        <div class="col-md-2 form-group" style="margin-top: 25px">
                            <input type="button" class="btn btn-success" value="GENERAR REPORTE" onclick="generarReporteProvicional();">
                        </div>
...
<script src="js/reporteProvicional.js"></script>
