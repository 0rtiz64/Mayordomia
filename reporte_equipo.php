        ...
        <form class="form-horizontal" id="formularioReporteEquipo">
         <section class="main-content-wrapper">
            <section id="main-content">
                <div class="row">
                    <h1 class="h1">REPORTE RESUMEN ASISTENCIA OVEJAS</h1>
                    <div class="col-md-12">
...
WHERE `status`=1");
                        ...
                        <div class="form-group col-md-2">
                            <input type="button" class="btn btn-info" value="Generar Reporte" onclick="ReporteEquipoOV()">
                        </div>


                        <div id="TablaReporteResumenEquipo"></div>
