    ...
    <form class="form-horizontal" id="formularioReporteEquipo">
        <section class="main-content-wrapper">
            <section id="main-content">
                <div class="row">
                    <h1 class="h1">REPORTE AUSENTES</h1>
                    <div class="col-md-12">

                        <div class="form-group">
                            <div class="col-md-10" id="divInputFecha">
                                <input type="date" class="form-control" id="fechaAusentes">
                            </div>
                            <div class="col-md-2">
                                <input type="button" class="btn btn-primary" value="GENERAR REPORTE" onclick="reporteAusentes()">
                            </div>
                        </div>

                        <div class="col-md-12" id="tablaAusentes"></div>
                    </div>
...
<script src="js/ausentes.js"></script>
