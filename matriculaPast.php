    ...
    <form class="form-horizontal" id="formularioReporteEquipo">
        <section class="main-content-wrapper">
            <section id="main-content">
                <div class="row">
                    <h1 class="h1">MATRICULA DE PASTOREADORES</h1>
                    <div class="col-md-12">

                        <div class="col-md-5" id="identidadDiv">
                            <input type="number" class="form-control" placeholder="IDENTIDAD" id="identidadInput">
                            <div id="alertIdentidadad" style="background-color: #D9534F; color: white; border-radius:4px" align="center" class="collapse">IDENTIDAD INVALIDA</div>

                        </div>

                        <div class="col-md-5" id="nombreDiv">
                            <input type="text" class="form-control" placeholder="NOMBRE COMPLETO" id="nombreInput" style="text-transform: uppercase">
                        ...
                        <div class="col-md-2">
                            <input type="button" class="btn btn-primary" value="GUARDAR" onclick="matricularPast()">
                        </div>

                        <div id="guardado" class="col-md-10"></div>
                    </div>
...
<script src="js/matriculaPast.js"></script>
