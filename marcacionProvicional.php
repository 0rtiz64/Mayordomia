    ...
    <form class="form-horizontal" id="formularioReporteEquipo">
        <section class="main-content-wrapper">
            <section id="main-content">
                <div class="row">
                    <h1 class="h1">MARCACION PROVICIONAL</h1>
                    <div class="col-md-12">
                        <form class="form-horizontal">
                        <div class="col-md-12 form-group" id="divInputProvicional">
                            <input type="password" class="form-control" placeholder="LEE EL CARNET" id="inputMarcacionProvicional" autofocus autocomplete="off">
                        </div>
                        <input type="submit" class="btn btn-success collapse" onclick="marcacionProvicionalActivar();">
                            <div class="col-md-12" id="cantidadActual">

                            </div>
                    <div class="col-md-12" id="resultado1"></div>
...
<script src="js/marcacionProvicional.js"></script>
