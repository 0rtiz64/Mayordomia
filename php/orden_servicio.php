...
<div>
	<p style="margin-left: 565px; margin-top:28px; position: absolute; font-size: 12px;"> <input type="checkbox"> </p>
	<p style="margin-left: 581px; margin-top:35px; position: absolute; font-size: 10px;"> Normal </p>
	
	<p style="margin-left: 620px; margin-top:28px; position: absolute; font-size: 12px;"> <input type="checkbox"> </p>
	<p style="margin-left: 638px; margin-top:35px; position: absolute; font-size: 10px;"> A Domicilio </p>


	<p style="margin-left: 565px; margin-top:49px; position: absolute; font-size: 12px;"> <input type="checkbox"> </p>
	<p style="margin-left: 581px; margin-top:56px; position: absolute; font-size: 10px;"> Garantia </p>

	<p style="margin-left: 620px; margin-top:49px; position: absolute; font-size: 12px;"> <input type="checkbox"> </p>
	<p style="margin-left: 638px; margin-top:56px; position: absolute; font-size: 10px;"> Contrato </p>
	

	<p style="margin-left: 565px; margin-top:69px; position: absolute; font-size: 12px;"> <input type="checkbox"> </p>
	<p style="margin-left: 581px; margin-top:76px; position: absolute; font-size: 10px;"> Demo </p>

	<p style="margin-left: 620px; margin-top:69px; position: absolute; font-size: 12px;"> <input type="checkbox"> </p>
	<p style="margin-left: 638px; margin-top:76px; position: absolute; font-size: 10px;"> Visita </p>

	<p style="margin-left: 565px; margin-top:92px; position: absolute; font-size: 12px;"> <input type="checkbox"> </p>
	<p style="margin-left: 581px; margin-top:99px; position: absolute; font-size: 10px;"> Cortesia </p>
...
<tbody>
	<tr>
		...
		<td WIDTH="40%">MEGACENTER SA</td>
		<td WIDTH="20%"> Fecha / Hora</td>
		<td WIDTH="20%">'.$fechaSistema.'</td>
	</tr>
...
$dompdf->loadHtml($contenido); 
 ...
 $dompdf->render();
 $dompdf->stream("Prestamo a ".$empresa." ".$fechaSistema,array('Attachment'=>0));
 ?>