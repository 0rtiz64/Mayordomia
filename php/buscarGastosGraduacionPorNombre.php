...
$confirmar = mysqli_num_rows(mysqli_query($enlace,"SELECT integrantes.nombre_integrante from detalle_integrantes
INNER JOIN promociones on detalle_integrantes.id_promocion = promociones.idpromocion
INNER JOIN integrantes on detalle_integrantes.id_integrante = integrantes.idintegrante
WHERE integrantes.nombre_integrante LIKE '%".$nombre."%' and promociones.`status` = 1 and detalle_integrantes.`status`= 1 and detalle_integrantes.id_cargo = 10"));

if($confirmar>0){
  $queryDatos = mysqli_query($enlace,"SELECT integrantes.idintegrante from detalle_integrantes
INNER JOIN promociones on detalle_integrantes.id_promocion = promociones.idpromocion
INNER JOIN integrantes on detalle_integrantes.id_integrante = integrantes.idintegrante
WHERE integrantes.nombre_integrante LIKE '%".$nombre."%' and promociones.`status` = 1 and detalle_integrantes.`status`= 1 and detalle_integrantes.id_cargo = 10");
