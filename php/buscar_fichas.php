...
");
        ...
        echo '<td> <a href="javascript:sendDataIntegracionIndividual(\''.$rows["cel"].'\',\''.$rows["nombre_integrante"].'\',\''.$rows["num_identidad"].'\','.$rows["correlativo"].','.$rows["idintegrante"].','.$numEquipo.',2)" class="btn btn-primary btn-sm">INTEGRACION </a></td>';
