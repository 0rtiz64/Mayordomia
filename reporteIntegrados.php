            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <form class="form-horizontal" id="formularioReporte">

                                <div class="form-group col-md-10" id="divReporte">
                                    <select  id="inputAreaReporte" class="form-control">
                                    ...
                                    <div id="alertReporte" style="background-color: #D9534F; color: white; border-radius:4px" align="center" class="collapse">DEBES SELECCIONAR UN AREA</div>

                                </div>
                                <input type="button" class="btn btn-primary" onclick="reporteIntegrados()" value="GENERAR REPORTE">
                            <div class="col-md-12">
