    ...
    <form class="form-horizontal" id="formularioReporteEquipo">
        <section class="main-content-wrapper">
            <section id="main-content">
                <div class="row">
                    <h1 class="h1">REPORTE ENLAZADOS</h1>
                    <div class="col-md-12">
                        <div class="col-md-12 form-group" id="divSelect">
                            <select  id="selectReporteEnlazados" class="form-control">
...
where promociones.`status`=1 AND equipos.num_equipo>0 AND equipos.`status`=1 GROUP BY num_equipo ASC");
                        ...
                        <div  id="tablaResultados" align="center"></div>
...
<script src="js/reporteEnlazadosController.js"></script>
