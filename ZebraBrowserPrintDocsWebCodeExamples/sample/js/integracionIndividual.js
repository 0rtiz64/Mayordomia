...
function sendDataIntegracionIndividual(cel,nombre,identidad,expediente,idIntegrante)
{
...
var integracion ="INTEGRACION";
            ...
            selected_printer.send(p1+integracion+p2+nombreNuevo+p3+idIntegrante+p4+cel+p5+identidad+p6+expediente+p7+1+p8);
