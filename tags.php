...
WHERE promociones.`status`=1 AND equipos.num_equipo >0");
                                while ($datosEquipos = mysqli_fetch_array($query,MYSQLI_ASSOC)){
                        ...
                        <div class="col-md-4 col-lg-4">
                            <input type="text" class="form-control" placeholder="Cantidad" id="cantidadTagsImprimir">
                        </div>

                        <div class="col-md-4 col-lg-4">
                            <input type="button" class="btn btn-info" value="Encabezado" onclick="consultarEncabezado();">
                            <input type="button" class="btn btn-primary" value="Imprimir" onclick="imprimirTags()">
                        </div>

                        <div class="col-md-12 col-lg-12 " id="tablaIntegrantes">
...
<script type="text/javascript" src="ZebraBrowserPrintDocsWebCodeExamples/sample/js/imprimirTags.js"></script>
