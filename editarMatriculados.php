    ...
    <form class="form-horizontal" id="formularioReporteEquipo">
        <section class="main-content-wrapper">
            <section id="main-content">
                <div class="row">
                    <h1 class="h1">CAMBIOS  MATRICULADOS</h1>
                    <div class="col-md-12">

                        <div class="col-md-12 form-group">
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="NOMBRE INTEGRANTE" id="inputCambiosMatricula" autocomplete="off" autofocus style="text-transform: uppercase;">
                            </div>

                        </div>

                        <div id="agrega-registros" class="col-md-12"></div>
                    </div>

                    <!-- Inicia Modal Cambios -->
                    <div class="modal fade" id="ModalEditarMatriculado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content ">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input type="button" class="btn btn-success" value="CARNET" onclick="consultarIdParaCarnet()">
                                    <input type="button" class="btn btn-danger" value="PDF" onclick="pdfModal()">
                                    <input type="button" class="btn btn-primary" value="ACTUALIZAR DATOS" onclick="actualizarDatosMatriculado();">
...
<script type="text/javascript" src="ZebraBrowserPrintDocsWebCodeExamples/sample/js/busquedaCarnet.js"></script>
...
<script src="js/editarMatriculados.js"></script>
